...
; 
; An identical copy of the original, except for the differences as
; introduced by nasm.  And of course some peculiarities that arrise
...
; Testcode
; --------------------------
;MOV ebx, [displ] ; [00007c2b]
;MOV word [ebx+2],0x00f3
;MOV word [ebx+6],0xf0f3
;MOV word [ebx+10],0xffff
;mainloop:
;jmp mainloop
; -------------------------
...
ekbd0:	dd nul, nul, nul, nul
	db 25q, 45q,  7 ,  0  			; x  .  i
ekbd:	db 17q,  1 , 15q, 55q 			; w  r  g  *
	db 14q, 26q, 20q,  1  			; l  u  d  r
	db 43q, 11q, 12q, 53q 			; -  m  c  +
	db  0 , 70q, 72q,  2  			;    S  C  t
	db  0 ,  0 ,  0 ,  0
	db  0 ,  0 ,  0 ,  0
...
; notes
; color.asm, boot.asm, gen.asm (shows up at blocks 0-11 in the editor)

; now include data
; first 6kb of data is the font (wich turns up at blocks 12 to 17 in the editor).
; the rest is actual cf source blocks (these turns up at block 18 and upwards)
%include 'data.dat'